                ...
                <View style={styles.ticketCard1}>
                    <ScrollView contentContainerStyle={styles.container1}>
                        <View style={styles.ticketContent}>
                            ...
                            <TouchableOpacity onPress={handleBatteryButtonClicked} style={styles.button}>
                            ...
                            {showBatteryPictures && (
                                <>
                                    ...
                                    <TouchableOpacity onPress={handleHelmetButtonClicked} style={styles.button}>
                                        <Text style={styles.btnText}>Now Click Helmet Pictures</Text>
                                    </TouchableOpacity>
                                </>
                            )}
                            {showHelmetPictures && (
                                <>
                                    ...
                                    <TouchableOpacity onPress={handleConnectorButtonClicked} style={styles.button}>
                                        <Text style={styles.btnText}>Now Click Connector Pictures</Text>
                                    </TouchableOpacity>
                                </>
                            )}
...
const ImagePickerExample: React.FC<ImagePickerExampleProps> = ({ direction }) => {
    ...
    return (
        <View >
            {!image && <TouchableOpacity onPress={pickImage} style={styles.imagePick}><Text style={styles.imageText}>{direction}</Text></TouchableOpacity>}
